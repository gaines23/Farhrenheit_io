# Generated by Django 3.2.6 on 2023-01-12 19:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ecstastream_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='EcstaStream_User_Steaming_List',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('created_by', 'ec_playlist_id'), name='user_playlist_constraint'),
        ),
        migrations.AddConstraint(
            model_name='ecstastream_user_steaming_list',
