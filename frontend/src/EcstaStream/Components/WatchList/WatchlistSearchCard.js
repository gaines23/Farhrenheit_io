...
import { addItemToWatchlist } from "../../lib/ec-api";
import { useWatchlistDispatch } from "../../store/WatchlistContext";
import LoadingSpinner from "../UI/LoadingSpinner";

const WatchlistSearchCard = ({item, listId}) => {
    const { sendRequest } = useHttp(addItemToWatchlist, true);
...
export default WatchlistSearchCard;