...
const NewPlaylistButton = () => {
    ...
    return (
        <Fragment>
            <div className="w-1/5 h-40 flex mx-auto">
                <button 
                    className="w-5/6 h-full flex flex-col bg-bg-fill/10 py-2 mx-auto border rounded-lg border-bg-fill/10 hover:bg-bg-fill/20 hover:text-input-fill/50 hover:shadow hover:shadow-md hover:shadow-input-fill/10"
