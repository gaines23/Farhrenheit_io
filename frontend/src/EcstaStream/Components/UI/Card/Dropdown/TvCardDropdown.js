...
const TvCardDropdown = ({setShowDetails, id}) => {
    ...
    return (
      <Fragment>
            <div className="flex h-full mr-2 rounded-lg bg-bg-fill/70 backdrop-blur-md backdrop-contrast-150 mx-1">
                <div className="h-80 md:h-92 lg:h-100 w-full grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 bg-gradient-to-br from-ec-purple/50 to-ec-orange/50 rounded-lg bg-bg-fill/70">
