...
const CreatePlaylistModal = ({setIsOpen}) => {
    return (
        <Fragment>
             <div id="modalWrapper" className="text-input-fill w-2/3 h-full justify-center items-center overflow-x-hidden fixed mx-auto z-50 outline-none focus:outline-none">
