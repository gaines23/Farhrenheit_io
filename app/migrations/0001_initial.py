# Generated by Django 3.2.6 on 2023-02-15 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='creator', to='app.ecstastreamprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_added', to='app.ecstastreamprofile')),
                ('playlist_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pl_id', to='app.ecstastreamplaylist')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('playlist_id', 'pl_mov_show_id', 'media_type'), name='playlist_data_constraint'),
        ),
        migrations.AlterUniqueTogether(
            name='ecstastream_playlist_data',
