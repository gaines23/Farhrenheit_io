...
const Favorites = () => {
    const { sendRequest, status, data: favoritesDetials, error } = useHttp(getFavoritesDetails, true);
    ...
    if (status === 'completed') {
        const media = favoritesDetials.favs_data;
                ...
                <div className="w-full h-full mx-auto pt-5 overflow-hidden">
                        ...
                        <div className="w-full h-full py-3 col-span-1">
                            <div className="h-1/4">
                                ...
                                <div className="h-10 text-xs my-auto float-left py-3 ml-2">
                                    | {favoritesDetials.username} | # Following
                                </div>
                            </div>

                            <div className="h-1/2 p-2">
                                {favoritesDetials.description}
                            </div>
                    ...
                    <div id="info" className="w-full h-full mx-auto flex">
                        ...
                        <div id="search" className="w-1/3 h-full px-4 flex flex-col">
                            ...
                            <SearchBar listID={favoritesDetials.ec_playlist_id} />
                        </div>
