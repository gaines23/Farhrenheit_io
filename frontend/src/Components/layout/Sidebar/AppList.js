...
const AppList = () => {
    ...
    const linkClassName = "flex group p-1 h-10 w-full items-center rounded-lg hover:bg-bg-fill/10 outline-none hover:border-y hover:border-bg-fill/30";
    ...
    return (
        <Fragment>
            ...
            <div className="w-11/12 h-full mx-auto my-2 border border-bg-fill/20 bg-bg-fill/10 rounded-md shadow-md shadow-bg-fill/10">
                ...
                <p className="w-full h-6 text-xs text-input-fill/30 mt-3 px-2">Apps</p>
